...
pos_x = -500 #a esquerda  #infectado01
pos_y = 300 # a altura
...
while janela_aberta: #Deixando a janela aberta
    ...
    if (pos_y <= -500): # a altura que ele vai
        pos_y = 600 # a altura que ele surge            eixo Y é pra cima e para baixo x pros lado


    pos_y -= velocidade_outros #zumbi andar
